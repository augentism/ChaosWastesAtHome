...
-- The shared counter table Chaos Wastes at Home reports from. Fetched
-- rather than created: a live buff keeps the proc_func closure it was
-- made with, so the old closure and a new one must be writing into one
-- table or the report reads zero for a buff that is working.
